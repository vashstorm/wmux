...
pub async fn create_skill(
    ...
    services::skills::create_skill(&state.app_state, skill).map_err(map_error)
}

#[tauri::command]
pub async fn get_skill(state: State<'_, IpcState>, id: String) -> Result<OmniSkillDef, String> {
    services::skills::get_skill(&state.app_state, &id).map_err(map_error)
}
...
pub async fn update_skill(
    ...
    services::skills::update_skill(&state.app_state, id, skill).map_err(map_error)
}

#[tauri::command]
pub async fn delete_skill(state: State<'_, IpcState>, id: String) -> Result<(), String> {
    services::skills::delete_skill(&state.app_state, &id).map_err(map_error)
}
