...
export function isOmniClientMessage(msg: unknown): msg is OmniClientMessage {
  ...
  return (
    typeof type === "string" &&
    CLIENT_MESSAGE_TYPES.includes(type as (typeof CLIENT_MESSAGE_TYPES)[number])
  )
}
...
export function isOmniServerEvent(msg: unknown): msg is OmniServerEvent {
  ...
  return (
    typeof type === "string" &&
    SERVER_EVENT_TYPES.includes(type as (typeof SERVER_EVENT_TYPES)[number])
  )
}
 ...
 */
export function isVoiceSessionContextMessage(
  msg: OmniClientMessage,
): msg is VoiceSessionContextMessage {
 ...
 */
export function isVoiceConfirmActionMessage(
  msg: OmniClientMessage,
): msg is VoiceConfirmActionMessage {
 ...
 */
export function isVoiceCancelActionMessage(
  msg: OmniClientMessage,
): msg is VoiceCancelActionMessage {
 ...
 */
export function isVoiceStopListeningMessage(
  msg: OmniClientMessage,
): msg is VoiceStopListeningMessage {
 ...
 */
export function isVoiceStartListeningMessage(
  msg: OmniClientMessage,
 ...
 */
export function isVoiceTranscriptDeltaEvent(
  event: OmniServerEvent,
): event is VoiceTranscriptDeltaEvent {
 ...
 */
export function isVoiceTranscriptDoneEvent(
  event: OmniServerEvent,
 ...
 */
export function isVoiceIntentReceivedEvent(
  event: OmniServerEvent,
): event is VoiceIntentReceivedEvent {
 ...
 */
export function isVoiceAssistantMessageEvent(
  event: OmniServerEvent,
 ...
 */
export function isVoiceSessionTimeoutEvent(
  event: OmniServerEvent,
