...
export class AudioPipeline {
	...
	async startCapture(onFrame: (frameBase64: string, sampleRate: number) => void, levelObserver?: AudioLevelObserver): Promise<void> {
		...
		this.scriptNode.onaudioprocess = (event) => {
			...
			const resampled = this.resamplePCM(inputData, inputBuffer.sampleRate, this.config.sampleRateInput);
