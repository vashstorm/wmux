...
import { SshHostKeyError } from "./SshHostKeyError.js";
import { SessionList } from "./SessionList.js";
import { Terminal } from "./Terminal.js";
import { TmuxWarning } from "./TmuxWarning.js";

export function MainPanel() {
	const { selectedConnectionId, selectedPane } = useAppState();
	const hasConnection = selectedConnectionId !== null;
