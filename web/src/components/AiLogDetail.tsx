	...
	return (
		...
		>
			<Box sx={{
				...
				<IconButton size="small" onClick={onClose} aria-label="Close detail" data-testid="ai-log-detail-close">
					...
					<>
						...
						<Box sx={{ mt: 0.5, mb: 2, p: 1.5, bgcolor: "background.default", borderRadius: "var(--radius-sm)", border: "1px solid", borderColor: "divider" }}>
							...
							{log.toolArgumentsJson && (
								<Box sx={{ mt: 1.5 }}>
									<Typography sx={{ fontSize: DETAIL_FONT_SIZE.label, color: "text.secondary", mb: 0.5 }}>
										Arguments
									</Typography>
									<Box
										component="pre"
