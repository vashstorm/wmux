...
export const PaneCanvas = memo(function PaneCanvas({
  ...
  if (panes.length === 0) {
    return (
      <Box
        className="pane-canvas-empty"
        data-testid="pane-canvas-empty"
        sx={{
          display: "flex",
      ...
      >
        <Box
          className="pane-canvas-empty-card"
          sx={{
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
        ...
        >
          ...
          <Typography
            variant="h6"
            className="pane-canvas-empty-title"
            sx={{
          ...
          <Typography
            className="pane-canvas-empty-text"
            sx={{
          ...
          <Typography
            className="pane-canvas-empty-subtext"
            sx={{
  ...
  return (
    ...
    >
      <Box
        className="pane-canvas-stage"
        sx={{ position: "relative", width: "100%", height: "100%" }}
      >
        {selectedPane && (
          <Box
            className="pane-canvas-terminal"
            data-testid="pane-canvas-terminal"
            sx={{
              position: "absolute",
              inset: 0,
              zIndex: 1,
          ...
          return (
            ...
            >
              {(isAttention || isAttentionExplicit) && (
                <Box
                  className="pane-box-attention-indicator"
                  sx={{
                    position: "absolute",
                    top: 6,
                    right: 6,
                  ...
                  <Box
                    ...
                    sx={{
                      ...
                      boxShadow: isAttentionExplicit
                        ? "0 0 6px var(--color-attention-explicit)"
                        : "0 0 6px var(--color-attention)",
                    }}
                  />
                </Box>
              )}
