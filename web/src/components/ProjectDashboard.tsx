...
export function ProjectDashboard() {
  ...
  const layoutSummary =
    layoutData && typeof layoutData === "object" && "windows" in layoutData
  ...
  const progressValue =
    progressData && typeof progressData === "object" && "percent" in progressData
  ...
  const aiUpdatedAt =
    hasAiHtml || aiStatus === "error" ? formatTimestamp(selectedProject.updatedAt) : "—"
  const aiStatusChip = (
    <Chip
          ...
          >
            ...
            >
              ...
              <Typography
                variant="caption"
                color="text.secondary"
                sx={{ fontSize: DETAIL_FONT_SIZE.label }}
              >
                Updated {aiUpdatedAt}
              </Typography>
            </Stack>
            ...
            >
              ...
              >
                ...
                <Typography
                  variant="body2"
                  color="text.secondary"
                  sx={{ fontSize: DETAIL_FONT_SIZE.body }}
                >
            ...
            >
              ...
              >
                <Typography
                  variant="body2"
                  color="text.secondary"
                  sx={{ fontSize: DETAIL_FONT_SIZE.body, textAlign: "center", mb: 2 }}
                >
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, pb: { xs: 2, md: 0 } }}>
            <Box>
              ...
              >
                ...
                <DetailRow
                  label="Last synced"
                  value={formatTimestamp(selectedProject.lastSyncedAt)}
                />
              </Paper>
            </Box>
